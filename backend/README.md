...
## Project Structure
    ...
    ├── testapiautocatalog_103222  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103222`
...
2. Clone this repo and `cd testapiautocatalog_103222`
